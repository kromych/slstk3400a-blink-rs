...
gpio!({
    ...
    switches: [
        ...
        PB7:    (pa_doutclr, pa_doutset, pa_douttgl),
        PB8:    (pa_doutclr, pa_doutset, pa_douttgl),
        PB11:   (pa_doutclr, pa_doutset, pa_douttgl),
        PB13:   (pa_doutclr, pa_doutset, pa_douttgl),
        PB14:   (pa_doutclr, pa_doutset, pa_douttgl),
        PC0:    (pa_doutclr, pa_doutset, pa_douttgl),
        PC1:    (pa_doutclr, pa_doutset, pa_douttgl),
        PC2:    (pa_doutclr, pa_doutset, pa_douttgl),
        PC3:    (pa_doutclr, pa_doutset, pa_douttgl),
        PC4:    (pa_doutclr, pa_doutset, pa_douttgl),
        PC8:    (pa_doutclr, pa_doutset, pa_douttgl),
        PC9:    (pa_doutclr, pa_doutset, pa_douttgl),
        PC10:   (pa_doutclr, pa_doutset, pa_douttgl),
        PC14:   (pa_doutclr, pa_doutset, pa_douttgl),
        PC15:   (pa_doutclr, pa_doutset, pa_douttgl),
        PD4:    (pa_doutclr, pa_doutset, pa_douttgl),
        PD5:    (pa_doutclr, pa_doutset, pa_douttgl),
        PD6:    (pa_doutclr, pa_doutset, pa_douttgl),
        PD7:    (pa_doutclr, pa_doutset, pa_douttgl),
        PE10:   (pa_doutclr, pa_doutset, pa_douttgl),
        PE11:   (pa_doutclr, pa_doutset, pa_douttgl),
        PE12:   (pa_doutclr, pa_doutset, pa_douttgl),
        PE13:   (pa_doutclr, pa_doutset, pa_douttgl),
        PF0:    (pa_doutclr, pa_doutset, pa_douttgl),
        PF1:    (pa_doutclr, pa_doutset, pa_douttgl),
        PF2:    (pa_doutclr, pa_doutset, pa_douttgl),
        PF3:    (pa_doutclr, pa_doutset, pa_douttgl),
        PF4:    (pa_doutclr, pa_doutset, pa_douttgl),
        PF5:    (pa_doutclr, pa_doutset, pa_douttgl),
    ],
    interrupts: [
