...
pub type EM4WUPOL_W<'a, REG> = crate::FieldWriter<'a, REG, 7, EM4WUPOL_A>;
impl<'a, REG> EM4WUPOL_W<'a, REG>
where
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn em4wupol(&mut self) -> EM4WUPOL_W<EM4WUPOL_SPEC> {
        EM4WUPOL_W::new(self, 0)
    }
