...
pub type HFCORECLKDIV_W<'a, REG> = crate::FieldWriter<'a, REG, 4, HFCORECLKDIV_A>;
impl<'a, REG> HFCORECLKDIV_W<'a, REG>
where
...
pub type HFCORECLKLEDIV_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hfcoreclkdiv(&mut self) -> HFCORECLKDIV_W<HFCORECLKDIV_SPEC> {
        HFCORECLKDIV_W::new(self, 0)
    }
    #[doc = "Bit 8 - Additional Division Factor For HFCORECLKLE"]
    #[inline(always)]
    #[must_use]
    pub fn hfcoreclklediv(&mut self) -> HFCORECLKLEDIV_W<HFCORECLKDIV_SPEC> {
        HFCORECLKLEDIV_W::new(self, 8)
    }
